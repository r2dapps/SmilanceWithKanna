        ...
        <div className="dark-card flex items-center justify-between p-3.5 backdrop-blur-xl border rounded-[2rem] shadow-[0_8px_30px_rgba(244,63,94,0.15)] overflow-hidden relative" style={{ background: 'linear-gradient(to right, var(--bg-top) 0%, var(--bg-bottom) 100%)', borderColor: 'var(--card-border)' }}>
          ...
          <div className="flex items-center gap-2.5 z-10">
            ...
            <div className="flex items-center gap-1.5 select-none">
              <h1 className="font-serif text-[18px] sm:text-[20px] font-bold tracking-wide mt-0.5 text-shimmer-glow transition-all duration-700 min-w-[100px] overflow-hidden whitespace-nowrap flex items-center justify-start gap-1">
                {showAltTitle ? (
                  <>
                    Nanna 
                    <Heart className="w-4 h-4 animate-heartBeat inline-block shrink-0 -mt-0.5" style={{ color: 'var(--accent-color)', fill: 'var(--accent-color)' }} /> 
                    Kanna
                  </>
                ) : (
                  "Smilance"
